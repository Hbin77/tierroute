...
| Period covered | Repository work on 2026-07-15 and 2026-07-16 through PR #41 |
...
| [PR #41](https://github.com/Hbin77/tierroute/pull/41) | `934aab6` plus PR branch commits; **REPO** | Deterministic regression-stump objective, residual/split/tie/resource design, inner-LODO calibrated GBM trainer, adversarial tests, claim boundaries, documentation, review, and repository workflow | Issue #40 acceptance record; hand-derived boosting, strict loss decrease, stable ordering, held-out isolation, exact OOF coverage, aggregate pre-embedding resource rejection, offline inference, and full CI evidence recorded in PR #41 | **PENDING** |
